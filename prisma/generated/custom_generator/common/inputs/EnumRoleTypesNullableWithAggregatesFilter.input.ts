...
import { NestedEnumRoleTypesNullableWithAggregatesFilter } from "./NestedEnumRoleTypesNullableWithAggregatesFilter.input";
import { NestedIntNullableFilter } from "./NestedIntNullableFilter.input";

@NestJsGraphQL.InputType('EnumRoleTypesNullableWithAggregatesFilter', { isAbstract: true })
